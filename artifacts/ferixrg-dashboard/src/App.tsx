...
function DashboardApp() {
  ...
  function Overview() {
    ...
    return <div className="page">
      <div className="page-header title-stage"><div className="title-stage-art" aria-hidden="true"><span className="brand-orbit orbit-one">{initials(activeStore?.name ?? "Store")}</span><span className="brand-orbit orbit-two">✦</span><span className="brand-orbit orbit-three"><Store size={18} /></span><i className="orbit-line" /></div><div className="title-stage-copy"><span className="eyebrow">Today · 18 June</span><h1>Make the next move.</h1><p>See your store at a glance.</p></div><div className="header-actions"><button className="btn" onClick={() => navigate("stores")}><Plus size={15} /> Add store</button><button className="btn primary" onClick={() => navigate("analysis")}><Play size={15} /> Analyze</button></div></div>
  ...
  function Stores() {
    ...
    return <div className="page"><div className="page-header"><div><span className="eyebrow">Store registry</span><h1>Your stores.</h1><p>Manage connected storefronts.</p></div><button className="btn primary" onClick={() => setModal("add-store")}><Plus size={15} /> Add store</button></div>
  ...
  function Analysis() {
    ...
    return <div className="page"><div className="page-header"><div><span className="eyebrow">Analysis</span><h1>Check your store.</h1><p>Choose a focus and run a check.</p></div><button className="btn" onClick={() => navigate("reports")}><FileBarChart size={14} /> Reports</button></div>
