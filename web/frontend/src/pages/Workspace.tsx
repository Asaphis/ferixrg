...
export default function Workspace() {
  ...
  function ToolsLibrary() {
    ...
    if (toolFlow !== "library") {
      ...
      return <ApprovedToolWorkflow key={`${selectedTool.id}-${toolFlow}`} tool={selectedTool} workspaceId={activeWorkspaceId} storeId={activeStore?.id} startAt={startAt} startSource={selectedToolSource ?? requestedToolSource ?? undefined} selectedSource={selectedToolSource ?? undefined} onBack={() => setToolFlow("library")} />;
    }
