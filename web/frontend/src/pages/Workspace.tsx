...
export default function Workspace() {
  ...
  function ToolsLibrary() {
    ...
    if (toolFlow !== "library") {
      ...
      return <ApprovedToolWorkflow key={`${selectedTool.id}-${toolFlow}`} tool={selectedTool} workspaceId={activeWorkspaceId} startAt={startAt} startSource={selectedToolSource ?? requestedToolSource ?? undefined} onBack={() => setToolFlow("library")} />;
    }
